...
async (conn, mek, m, { reply }) => {
    try {
        ...
        const localTime = now.toLocaleTimeString("en-US", { 
            ...
            second: "2-digit", 
            hour12: true,
            timeZone: "Africa/Nairobi" // Setting Kenya's time zone explicitly
        });
        
        // Send the local time as reply
        reply(`🕒 Current Local Time in Nairobi: ${localTime}`);
    } catch (e) {
...
async (conn, mek, m, { reply }) => {
    try {
        ...
        // Get the formatted date (e.g., "Friday, September 12, 2025")
